...
load('data/processed/climate/gridded_clim_il.RData')
load('data/processed/climate/gridded_clim_in.RData')
load('data/processed/climate/gridded_clim_mi.RData')
load('data/processed/climate/gridded_clim_mn.RData')
load('data/processed/climate/gridded_clim_wi.RData')

# Combine gridded soil data
clim_grid <- rbind(IL_clim_grid, IN_clim_grid, MI_clim_grid, MN_clim_grid, WI_clim_grid)
...
new_grid <- new_grid |>
  dplyr::rename(state = ID,
                grid_id = `p$id`) |>
  dplyr::select(state, grid_id, ppt_mean, ppt_sd,
                tmean_mean, tmean_sd, tmin, tmax,
                vpdmin, vpdmax, x, y)
...
# gridded soil data
IL_clim_grid <- rbind(IL_clim_grid, IL_new_grid)
IN_clim_grid <- rbind(IN_clim_grid, IN_new_grid)
MI_clim_grid <- rbind(MI_clim_grid, MI_new_grid)
MN_clim_grid <- rbind(MN_clim_grid, MN_new_grid)
WI_clim_grid <- rbind(WI_clim_grid, WI_new_grid)
